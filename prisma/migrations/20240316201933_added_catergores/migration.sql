...
-- CreateTable
CREATE TABLE "_AnswerToCategory" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- AddForeignKey
ALTER TABLE "_AnswerToCategory" ADD CONSTRAINT "_AnswerToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "Answer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
